...
otherArticles:
  [
    { collection: "articles", id: "technology-for-social-justice-conference-2024" },
    { collection: "articles", id: "not-for-profit-tech-deals" },
    { collection: "articles", id: "welcome-to-neon-carrot" },
  ]
pubDate: 2024-07-01
---
...
<div className="border spv-8" style={{ padding: "1.5rem 1.5rem 0rem" }}>
  **Who this article is for:**
  ...
  - Organisations that want to see what a proof-of-concept AI chatbot could look like. <a href="/demos/retrieval-augmented-generation">Check it out here!</a>
</div>
